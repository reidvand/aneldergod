...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aneldergod
```

A live public deployment of this template is available at [https://aneldergod.templates.workers.dev](https://aneldergod.templates.workers.dev)
